 ...
 *
 */
public class NoElkiTotalCorrelation extends MultidimensionalDependency {
    ...
    public NoElkiTotalCorrelation(double[][] values, int k){
        ...
        this.knn = new KNN(this.values, this.k_nearestNeighbour+1);
    }
    ...
    /**
     *
     * @param value is the objectVector of our currently observed object
     * @return the cardinalities of each dimensionBin for this object
     */
    public int[] getBinCardinalities(double[] value){
        ...
        double[] distance = knn.getKNNDistances(value); // we get the distance in each dimension for our value
        /*
    ...
    public int[][] getAllBinCardinalities(){
        ...
        for(int i = 0; i < OBJECTS; i++){ // for each object
            ...
            allCardinalities[i]=getBinCardinalities(v); // we calculate the Cardinalities for each object and safe them
        }
