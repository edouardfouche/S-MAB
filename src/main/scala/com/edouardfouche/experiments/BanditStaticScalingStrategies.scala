...
/**
  ...
  */
object BanditStaticScalingStrategies extends BanditSyntheticExperiment {
  val d = 100
  val lmin = 1
  val lmax = d
  ...
  val scalingstrategies: Array[ScalingStrategy] = Array(
    ...
    KLBasedScalingPlus(lmin, lmax, 0.9),
    NaiveScaling1(lmin, lmax, 0.9, 0.1),
    NaiveScaling2(lmin, lmax, 0.9),
    NaiveScaling3(lmin, lmax, 0.9)
  )
